...
def main():
    ...
    for article in feed.entries:
        ...
        prompt = (
            ...
            f"1. Заголовок: Сформулируй жестко под конкретные поисковые запросы геймеров (например, вместо 'Новая игра' пиши 'Скачать лучшие моды на графику для...'). "
            f"2. Приветствие: Начни с живого приветствия аудитории канала Level UP. "
            f"3. SEO и трафик: Органично вшивай нужные ключевые слова в текст, чтобы нас находили через поиск Яндекса и Google. "
            f"4. Глубина и объем: Раскрой инфоповод максимально широко. Добавь предысторию серии, проанализируй влияние новости на индустрию, используй сторителлинг. "
            ...
            f"6. Вовлечение: Заверши лонгрид призывом к читателям спуститься в комментарии и задай им провокационный вопрос по теме. "
            f"7. Форматирование: Используй стандартный Markdown (**жирный текст**). Выделяй только самое важное, не перегружай текст."
            f"\n\nНовость: {title}\nТекст: {clean_text}"
        )
