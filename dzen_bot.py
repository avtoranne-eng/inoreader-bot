...
def main():
    ...
    for article in feed.entries:
        ...
        prompt = (
            ...
            f"7. Форматирование: Обязательно используй Markdown (жирный шрифт для заголовков и важных мыслей, курсив для названий игр и Мнения редакции). Дели текст на удобные абзацы."
            f"\n\nНовость: {title}\nТекст: {clean_text}"
        )
